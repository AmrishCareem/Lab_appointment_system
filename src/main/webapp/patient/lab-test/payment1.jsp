          ...
          <!-- <li class="nav-item">
            ...
            <div class="collapse" id="lab-assistant">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="../../admin/lab-assistant/lab-assistant-create.jsp">Create Lab Assistant</a></li>   
              ...
              <div class="card-body">
                ...
                <form class="forms-sample">         
                  <div class="form-group">
                    <label for="exampleInputDoctorPrice">Amount</label>
                    <input type="text" class="form-control" id="exampleInputDoctorPrice" placeholder="3000">
                  </div>

                  <button type="submit" class="btn btn-primary me-2"><a href="payment/1.pdf">Submit</a></button>
                  <button class="btn btn-light" ><a href="lab-test-result-view.jsp">Cancel</a></button>
                </form>
              </div>
            </div>
          </div>
