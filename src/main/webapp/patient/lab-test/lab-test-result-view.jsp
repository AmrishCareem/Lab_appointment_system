        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
              ...
              <span class="nav-profile-name">Patient</span>
            </a>
        ...
        <ul class="nav">
          ...
          <!-- <li class="nav-item">
            ...
            <div class="collapse" id="lab-assistant">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../patient/lab-assistant/lab-assistant-view.jsp">View Lab Assistant</a></li> 
                <li class="nav-item"> <a class="nav-link" href="../../patient/lab-assistant/lab-assistant-create.jsp">Create Lab Assistant</a></li>   
          ...
          <!-- <li class="nav-item">
            ...
            <div class="collapse" id="patient">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../patient/patient/patient-view.jsp">View Patients</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../patient/patient/patient-create.jsp">Create Patients</a></li>  
              </ul>
            </div>
          </li> -->
          ...
          <!-- <li class="nav-item">
            ...
            <div class="collapse" id="doctor">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../patient/doctor/doctor-view.jsp">View Doctors</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../patient/doctor/doctor-create.jsp">Create Doctors</a></li>   
              </ul>
            </div>
          </li> -->
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="lab-test">
              <ul class="nav flex-column sub-menu">
                <!-- <li class="nav-item"> <a class="nav-link" href="../../patient/lab-test/lab-test-register-view.jsp">Test Register</a></li> -->
                <!-- <li class="nav-item"> <a class="nav-link" href="../../patient/lab-test/lab-test-type-view.jsp">Test Type</a></li>  -->
                <li class="nav-item"> <a class="nav-link" href="../../patient/lab-test/lab-test-result-view.jsp">Test Result</a></li>   
              </ul>
            </div>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <a href="../../patient/lab-test/payment1.jsp">
                          <i class="mdi mdi-currency-usd text-success"
                          style="font-size: 24px;"></i>
                          </a>
                        </td>
