        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
              ...
              <span class="nav-profile-name">Lab Assitant</span>
            </a>
        ...
        <ul class="nav">
          ...
          <!-- <li class="nav-item">
            ...
            <div class="collapse" id="lab-assistant">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"> <a class="nav-link" href="../../lab-assistant/lab-assistant/lab-assistant-create.jsp">Create Lab Assistant</a></li>   
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="patient">
              <ul class="nav flex-column sub-menu">
                ...
                <!-- <li class="nav-item"> <a class="nav-link" href="../../lab-assistant/patient/patient-create.jsp">Create Patients</a></li>   -->
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="doctor">
              <ul class="nav flex-column sub-menu">
                ...
                <!-- <li class="nav-item"> <a class="nav-link" href="../../lab-assistant/doctor/doctor-create.jsp">Create Doctors</a></li>    -->
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="lab-test">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../lab-assistant/lab-test/lab-test-register-view.jsp">Test Register</a></li>
                <!-- <li class="nav-item"> <a class="nav-link" href="../../lab-assistant/lab-test/lab-test-type-view.jsp">Test Type</a></li>  -->
                <li class="nav-item"> <a class="nav-link" href="../../lab-assistant/lab-test/lab-test-result-view.jsp">Test Result</a></li>   
              </ul>
            </div>
          </li>
          ...
          <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-header">
                <h4>LAB TEST REGISTER
                <a href="lab-test-register-create.jsp" class="btn btn-primary btn-sm text-white float-end">Create</a>
            </h4>
       </div>
              <div class="card-body">
